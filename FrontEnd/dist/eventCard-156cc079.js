import{x as e,s as t}from"./navbar-ab6020c8.js";customElements.define("input-image",class extends t{render(){return e`
    <style>
    .file-label {
        cursor: pointer;
    ...
    <div class="card">
      <h3 class="title">${(t=this).title}</h3>
      <p class="description">${t.description}</p>
      <countdown-timer></countdown-timer>
      <input-image class="card-img" .selectedFile=${t.img}></input-image>
